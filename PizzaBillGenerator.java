...
// 🍕 Pizza class: Represents a pizza with size, toppings, and quantity
class Pizza {
    String size;
...
// 👤 Member 1: Handles user input and creates pizza orders
class OrderHandler {
...
// 👤 Member 2: Calculates subtotal, tax, and total
